...
/**
 * GET ALL PRODUCTS MOCK API CALL:
 * - Returns a Promise with all of the Products
 *
 * **/
...
/**
 * CREATE PRODUCT MOCK API CALL:
 * - Accepts an Data which is of type ProductInput
 * - Returns true if accepted, else error if missing input data
 *
 * **/
...
/**
 * GET SINGLE PRODUCT MOCK API CALL:
 * - Accepts an ID which is a string
 * - Returns a single product, error if Product not found
 *
 * **/
